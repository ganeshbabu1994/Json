...
.append("g")
.attr("transform", "translate(" + ((width/2)+50 )+ "," + ((height / 2.5 ))+ ")");
...
d3.json("json/agewise_literates.json",function(error, data) {
  ...
  .on("mouseover", function(d){return tooltip.style("visibility", "visible"),tooltip.text("Age:"+d.data["Age-group"]+"=>"+"Population:"+(d.data["Literate"]));})
  ...
  .text(function(d) { return " - persons : "+d.data.Literate+" Age : "+d.data["Age-group"]; });
